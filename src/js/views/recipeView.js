...
class RecipeView extends View {
  ...
  _errorMessage = "Could not find that recipe, try another search!";
  _searchMessage = "";
  ...
  _generateMarkup() {
    ...
    <img src="${this_data.image}" alt="${
      this_data.title
    }" class="recipe__img" />
    <h1 class="recipe__title">
      <span>${this_data.title}</span>
    </h1>
  </figure>
  ...
  <div class="recipe__ingredients">
    ...
    ${this_data.ingredients.map(this_generateMarkupIngredient).join("")}
  </div>
